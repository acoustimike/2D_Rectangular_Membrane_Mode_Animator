...
%   14/11/2018 - Moved various default settings to top of code (latex etc)
%
% To Do  :
%   (1) Display formatting breaks for aspect ratio of 1 (square) due to excessive
...
option_MakeVideo    = 0;    % Make a video (1), don't make a video (0)
...
Psi                 = 0.2*(X_x_mat.*Y_y_mat);       % The (2D) characteristic function
T_t                 = cos(2*pi*f*tVec);             % Time harmonic signal
...
annotation(fig1,'textbox',...
    ...
    'FitBoxToText','off','FontSize',figFont-8);
